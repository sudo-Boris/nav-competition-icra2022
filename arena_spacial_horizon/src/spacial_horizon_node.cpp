...
{   
    ...
    goal_sub_ = public_nh.subscribe("move_base_goal", 1, &SpacialHorizon::goalCallback,this);
...
void SpacialHorizon::goalCallback(const move_base_msgs::MoveBaseGoal& msg){
    ...
    end_pos_=Eigen::Vector2d(msg.target_pose.pose.position.x,msg.target_pose.pose.position.y);
